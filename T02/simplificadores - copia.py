...
class SuperInput:
    ...
    def es_float(self, tipo):
        ...
        '''
        ***   INNECESARIO PARA LA T02 DE PROGRAMACION AVANZADA   ***
        def es_mail(self, tipo):
            email = ListaLigada('email', 'mail', 'correo electronico')
            if tipo in email:
                return True
            return False
        '''
...
class Menu():
    ...
    def menu(self):
        ...
        while not stop:
            ...
            if isinstance(self.lista_opciones, list) or isinstance(self.lista_opciones, ListaLigada):
                if isinstance(self.lista_funciones, list) or isinstance(self.lista_funciones, ListaLigada):
                    ...
                    if len(self.lista_funciones) == len(self.lista_opciones):
                        ...
                        entrada = int(SuperInput('>>> Elige una opcion: ', 'int').superinput())
...
#Todo lo que esta de aqui en adelante no es usando en ninguna parte de la T02 de Programacion Avanzada
#-----------------------------------------------------------------------------------------------------------------------
