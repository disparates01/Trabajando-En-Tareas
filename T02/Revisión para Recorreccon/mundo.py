...
class Mundo:
    ...
    def mostrar_estad_por_pais(self):
        ...
        for i, j in conteo:
            print('{} {}'.format(i,j.nombre)) #arreglo: agregue el .format
            diccionario_paises[i] = j
        entrada = SuperInput('int',
            '>>> Ingresa el numero del pais que quieres revisar: ').superinput() #arreglo: Agregue .superinput()
