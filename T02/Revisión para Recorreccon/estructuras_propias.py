...
class ListaLigada:
    ...
    def index(self, elem):
        ...
        # Busca el elemento:
        for i in range(self.len): #arreglo: Elimine en +1
...
class Diccionario:
    ...
    def __getitem__(self, llave):
        ...
        # Si no esta:
            ...
            raise KeyError('La llave entregada no pertenece al diccionario: {}'.format(llave)) #arreglo: Agregue el .format(llave)
...
if __name__ == '__main__':
    ...
    # print(lista[2:])
    print('---')
    print('Probando __str__ Lista Ligada')
    print(lista)
