...
# si los archivos estan en otra carpeta, ingresar el path como parametro
# de la funcion
    ...
    for name in file_names:
        ...
        for country in all_countries:
            ...
            while random_number_generator > 0:
                ...
                # agregamos el pais al set de forma (pais_actual,
                # pais_donde_puedo_llegar)
